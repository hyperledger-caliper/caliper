...
describe.only('When using Internal Transaction Observer', () => {
    ...
    describe('Construction', () => {
        it('should initialize with correct properties', () => {
            sinon.stub(ConfigUtil, 'get').returns(DEFAULT_UPDATE_INTERVAL);
            ...
            expect(observer.updateInterval).to.equal(DEFAULT_UPDATE_INTERVAL);
    ...
    describe('Activating and scheduling updates', () => {
        it('should activate the observer and start sending periodic updates', async () => {
            ...
            clock.tick(DEFAULT_UPDATE_INTERVAL);
        ...
        it('should handle very large updateInterval without sending updates prematurely', async () => {
            const VERY_LARGE_INTERVAL = 24 * 60 * 60 * 1000; // 24 hours in milliseconds
